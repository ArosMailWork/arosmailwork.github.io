...
### 1. **Tạo Shader Mới**:  
   ...
   - ![alt text](https://github.com/ArosMailWork/arosmailwork.github.io/blob/main/_posts/Images/select%20shader.png)
...
+ Pass: Chứa các bước thực thi cho vertex shader hoặc fragment shader (Surface Shader không phải 1 shader lẻ, sẽ được làm rõ trong 1 bài nói về low-level graphic programming)

**📝 NOTE:**  
> Một số thuộc tính render (không có trong file gen mặc định)

> Cull Off, ZWrite Off, ZTest Always, LOD : Các thuộc tính này thiết lập trước CGPROGRAM
...
Hmmmmmm, cũng khá là đẹp, bây giờ chúng ta hãy loại bỏ màu của tấm Mask bằng việc loại bỏ màu sắc của nó với câu lệnh set thuộc tính
...
Lý do là vì trong camera nó vẫn render ra ở thông số depth (giá trị biểu thị khoảng cách)

**depth view image here**

Vậy là chúng ta chỉ cần bảo là skip không vẽ tấm Mask này nữa là xong 
...
![alt text](https://github.com/ArosMailWork/arosmailwork.github.io/blob/main/_posts/Images/1.png)
![alt text](https://github.com/ArosMailWork/arosmailwork.github.io/blob/main/_posts/Images/2.png)

Các script được sử dụng trong scene có thể download:
